...
export const metadata = {
  ...
  description: 'Feed de projetos em formato de rede profissional.',
};

export default function ProjetosPage() {
  return (
    <section style={{ maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontWeight: 800, letterSpacing: '-0.02em' }}>Projetos</h1>
      <p style={{ color: 'var(--color-muted)' }}>Exploração de projetos em formato de feed profissional.</p>
            ...
            <CardHeader>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ display: 'grid' }}>
                  ...
                  {post.createdAt ? (
                    <time dateTime={post.createdAt} style={{ color: 'var(--color-muted)', fontSize: 12 }}>
